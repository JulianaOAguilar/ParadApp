...
export default function CreatePointScreen({ route, navigation }: Props) {
  ...
  const [foto, setFoto] = useState<string | null>(null) // 📸 STATE DA MÍDIA
...
async function escolherImagem() {
  ...
  const fileName = `pontos/${Date.now()}-${Math.random()}.jpg`

  try {

    // 🔥 MELHOR FORMA NO EXPO
    ...
    Alert.alert("Erro inesperado ao enviar imagem")
  }
}
      ...
      .insert([
        {
          ...
          foto_url: foto, // 📸 AQUI VAI A IMAGEM
          latitude: null,
          longitude: null,
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity style={styles.mediaBox} onPress={escolherImagem}>
        <Text style={styles.mediaIcon}>📷</Text>
        <Text style={styles.mediaText}>
          {foto ? "Imagem adicionada ✔" : "Adicionar fotos ou vídeos"}
        </Text>
      </TouchableOpacity>
